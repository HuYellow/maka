...
export const LongSystemNotes: Story = {
  ...
  play: async ({ canvasElement }) => {
    ...
    // ChatView materializes the virtualized turn after the shell first mounts.
    await waitFor(() => expect(canvasElement.querySelectorAll('.maka-chat-system-message')).toHaveLength(4));
